-- ============================================================
-- Ligo Wallet Service — init.sql
-- Runs ONLY on a fresh (empty) volume.
-- For existing volumes, see: docker compose down -v && docker compose up --build
-- ============================================================
...
-- ─── Seed: wallets ───────────────────────────────────────────────────────────
-- NOTE: The default admin user is seeded by SeedService on app boot (not here),
-- because password hashing requires the Node.js runtime (scrypt).
